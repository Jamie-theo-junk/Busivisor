...
class BusinessPagePersonalRecyclerAdapter(
    private val idea: BusinessIdea
) : RecyclerView.Adapter<BusinessPagePersonalRecyclerAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.business_page_rec_card_personal, parent, false)
