...
import com.jamie.businessideasevaluator.View.Adapters.BusinessPageBusinessRecyclerAdapter.ViewHolder

class BusinessPageBusinessRecyclerAdapter(
    private val idea: BusinessIdea
) : RecyclerView.Adapter<BusinessPageBusinessRecyclerAdapter.ViewHolder>() {

    private val analysisList: List<Pair<String, Int>> = idea.businessAnalysis.toList()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.business_page_rec_card_business, parent, false)
